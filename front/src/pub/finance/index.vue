    ...
    <div id="finace">
        <el-form v-model="searchForm" :rules="rules" :inline="true">
            <el-row>
                ...
                <el-col :span="8">
                    <el-form-item>
                        <el-button type="primary" icon="el-icon-search" @click="getFinanceList(searchForm)">查询</el-button>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
export default {
    ...
    methods: {
        formateDate,
        getFinanceList(searchForm) {
            if (this.searchForm.createTimeRange == null || this.searchForm.createTimeRange === '') {
                this.searchForm.startTime = '';
                this.searchForm.endTime = '';
            } else {
                this.searchForm.startTime = this.formateDate(this.searchForm.createTimeRange[0]);
